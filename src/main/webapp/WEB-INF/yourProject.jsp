...
<body>
    <nav class="navbar navbar-expand-xl navbar-dark bg-dark p-3">
        <div class="container-fluid gap-1">
            <a class="navbar-brand display-1" href="#" style="font-size: 24px;">Your Projects</a>
    	...
    	<h3 class="text-secondary">Your Project:</h3>
                        ...
                        <c:choose>
                            <c:when test="${project.owner.id == user.id}">
                                <td class="d-flex gap-2">
                                    <a class="btn btn-outline-primary" href="/project/edit/${project.id}">Edit</a>
                            ...
                            <c:otherwise>
                                <td>
                                    <form action="/project/leave/${project.id}" method="post">
                                        <input type="submit" class="btn btn-outline-warning" value="Leave Project" />
                                    </form>
                                </td>
                            </c:otherwise>
                        </c:choose>
