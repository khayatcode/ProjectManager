...
<body>
    <nav class="navbar navbar-expand-xl navbar-dark bg-dark p-3">
        <div class="container-fluid gap-1">
            <a class="navbar-brand display-1" href="#" style="font-size: 24px;">Create Project</a>
    ...
    <div class="container mt-3">
        <h3 class="text-secondary">Create Project</h3>
        <form:form action="/project/new/create" method="post" modelAttribute="project">
